...
const AppSidebar = () => {
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <SidebarMenu className="data-[state=open]:bg-red-400">
          <SidebarMenuItem>
            <SidebarMenuButton tooltip="Micorza" asChild>
              <Link to={'/'}>
                <span className="text-lg">Micorza</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
            ...
            <SidebarMenu>
              {navItems.map((item) => (
                <SidebarMenuItem key={item.label}>
                  <SidebarMenuButton tooltip={item.label} asChild isActive={isLinkActive(item.to)}>
                    <Link to={item.to}>
                      <item.icon />
