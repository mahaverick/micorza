...
import { ForgotPassword, Login, Register, ResetPassword } from '@/router/routes/lazy.routes'
    ...
    children: [
      {
        path: 'login',
        element: (
          <Suspense fallback={<SuspenseLoader size="large" text="Loading Login Page..." />}>
            <Login />
          </Suspense>
        ),
      },
      {
        path: 'register',
        element: (
          <Suspense fallback={<SuspenseLoader size="large" text="Loading Register Page..." />}>
            <Register />
          </Suspense>
        ),
      },
